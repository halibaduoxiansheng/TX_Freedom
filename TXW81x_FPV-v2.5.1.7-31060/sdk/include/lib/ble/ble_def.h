...
enum BLE_LL_IOCTL {
    ...
    BLE_IOCTL_SET_ADV_DATA,
    BLE_IOCTL_SET_SCAN_RESP,
    BLE_IOCTL_SET_ADV_INTERVAL,
    BLE_IOCTL_SET_ADV_EN,
    BLE_IOCTL_SET_ADV_TYPE_FILTER,
    BLE_IOCTL_GET_PERR_ADDRTYPE,
    BLE_IOCTL_GET_PERR_ADDR,
    BLE_IOCTL_GET_CONN_INTERVAL,
    BLE_IOCTL_GET_CONN_LATENCY,
    BLE_IOCTL_GET_SUPERVISION_TIMEOUT,
    BLE_IOCTL_SET_COEXIST_EN,
    BLE_IOCTL_GET_COEXIST_CRASH,
};
